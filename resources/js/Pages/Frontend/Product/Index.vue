    ...
    <FrontendLayout>
        ...
        <div class="mt-4 mx-4 ">
            <div class="flex justify-between">
                <h5>Product Lists</h5>
                <Link :href="route('product.create')" class="bg-blue-500 text-white p-3 rounded mb-4">Add Product</Link>
            </div>
                    <table class="w-full bg-white border border-grey-200 shadow">
                        <thead>
                            <tr >
